...
const Navbar = () => {
  ...
  return (
    <nav className="bg-cream dark:bg-charcoal border-b border-goldAccent/20 py-4 px-4 md:px-8">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center gap-2">
          ...
          <h1 className="font-playfair font-bold text-2xl text-indigo dark:text-turquoise">
      ...
      {/* Mobile Navigation */}
      {isOpen && (
        <div className="md:hidden bg-cream dark:bg-charcoal/95 absolute z-50 left-0 right-0 px-4 py-5 shadow-lg animate-fade-in">
